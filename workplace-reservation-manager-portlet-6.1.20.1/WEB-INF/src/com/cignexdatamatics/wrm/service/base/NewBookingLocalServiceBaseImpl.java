...
/**
 * The base implementation of the new booking local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cignexdatamatics.wrm.service.impl.NewBookingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.cignexdatamatics.wrm.service.impl.NewBookingLocalServiceImpl
 * @see com.cignexdatamatics.wrm.service.NewBookingLocalServiceUtil
 * @generated
 */
public abstract class NewBookingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NewBookingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cignexdatamatics.wrm.service.NewBookingLocalServiceUtil} to access the new booking local service.
	 */
	...
	public NewBooking addNewBooking(NewBooking newBooking)
		...
		return newBookingPersistence.update(newBooking, false);
	}
	 ...
	 */
	public NewBooking createNewBooking(long bookingId) {
		return newBookingPersistence.create(bookingId);
	}
	...
	public NewBooking deleteNewBooking(long bookingId)
		throws PortalException, SystemException {
		return newBookingPersistence.remove(bookingId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NewBooking deleteNewBooking(NewBooking newBooking)
		throws SystemException {
		return newBookingPersistence.remove(newBooking);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(NewBooking.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return newBookingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return newBookingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return newBookingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public NewBooking fetchNewBooking(long bookingId) throws SystemException {
		return newBookingPersistence.fetchByPrimaryKey(bookingId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NewBooking getNewBooking(long bookingId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return newBookingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<NewBooking> getNewBookings(int start, int end)
		throws SystemException {
		return newBookingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getNewBookingsCount() throws SystemException {
		return newBookingPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NewBooking updateNewBooking(NewBooking newBooking)
		throws SystemException {
		return updateNewBooking(newBooking, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NewBooking updateNewBooking(NewBooking newBooking, boolean merge)
		throws SystemException {
		newBooking.setNew(false);

		return newBookingPersistence.update(newBooking, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cignexdatamatics.wrm.model.NewBooking",
			newBookingLocalService);
	}
	...
	private NewBookingLocalServiceClpInvoker _clpInvoker = new NewBookingLocalServiceClpInvoker();
}